...
- To report security vulnerabilities, please open an issue - and we will try to address the concern as fast as possible.
...
When in doubt, open a question on the issues list.